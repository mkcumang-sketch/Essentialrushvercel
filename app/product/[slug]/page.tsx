...
export default function ProductClientPage({ initialProduct }: ProductClientPageProps) {
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      try {
        ...
        const pubReviews = (revRes.data || []).filter((r: any) => 
  ...
  const handleAddToCart = (e: React.MouseEvent) => {
    ...
    // Fix: strict typing for slug to prevent TS2322 undefined string error
    const productToAdd = {
      ...initialProduct,
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-auto">
            <motion.button 
              ...
              className="flex-1 bg-black text-white py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#D4AF37] hover:text-black transition-all flex items-center justify-center gap-2 shadow-xl"
            >
